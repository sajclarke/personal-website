...
export default function Footer() {
  return (
    <footer className="mt-6 bg-transparent text-gray-600 dark:text-gray-200">
      <div className="">
        <div className="max-w-5xl mx-auto p-3 text-center flex items-center justify-between border-t border-gray-200 dark:border-gray-400">
