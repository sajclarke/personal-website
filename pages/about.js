        ...
        <section className="max-w-5xl mb-10 text-gray-700 body-font overflow-hidden">
          <div className="flex flex-col flex-col-reverse md:flex-row md:items-center">
            <div className=" my-10 md:my-5 flex flex-col items-start">
              ...
              <h2 className="sm:text-3xl text-2xl title-font font-medium text-gray-900 my-4">
                My Background
              </h2>
              <p className="leading-relaxed mb-8">
                Since I've known myself, I've always enjoyed the process of
                bringing an idea from concept to reality which has led me to
                creating visual arts, electronic circuits and more recently,
                computer software. I am particularly obsessed with ideas that
                can empower people to live better lives.
              </p>
              <p className="leading-relaxed mb-8">
